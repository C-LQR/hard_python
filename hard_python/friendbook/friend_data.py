...
names = [] # [(1,'张三'),(2,'李四')]
records = [] # [((1,'张三'),'骂了',(2,'李四'),-1),((1,'张三'),'请吃饭',(2,'李四'),+1)]
record_dict = {} # {933:[((1,'张三'),'骂了',(2,'李四'),-1)]}
name_dict = {} # id:张三
score_dict = {} # {256:{257:9,258:5}}
...
def build_score():
    for r in records: # 王五 打了 李四 -1
        ...
        if account_id in score_dict:
            ...
            score_dict[account_id] = {account_id:score}
